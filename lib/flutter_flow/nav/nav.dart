...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) => appStateNotifier.showSplashImage
          ? Builder(
              builder: (context) => Container(
                ...
                child: Image.asset(
                  'assets/images/novo_logo_crp_-_Copy.png',
                  fit: BoxFit.cover,
                ),
              ),
            )
      ...
      routes: [
        ...
        FFRoute(
            name: CalcularRendaPassivaPageWidget.routeName,
            path: CalcularRendaPassivaPageWidget.routePath,
        ...
        FFRoute(
          ...
          path: CalcularRendaPassivaResultWidget.routePath,
          builder: (context, params) => CalcularRendaPassivaResultWidget(
            prazo: params.getParam(
              'prazo',
              ParamType.int,
            ),
            ...
            valorRecorrente: params.getParam(
              'valorRecorrente',
              ParamType.double,
            ),
            taxaMensal: params.getParam(
              'taxaMensal',
              ParamType.double,
            ),
            renda: params.getParam(
        ...
        FFRoute(
            ...
            builder: (context, params) => params.isEmpty
                ? NavBarPage(initialPage: 'ContactPage')
                : NavBarPage(
                    initialPage: 'ContactPage',
                    page: ContactPageWidget(),
                  )),
        FFRoute(
