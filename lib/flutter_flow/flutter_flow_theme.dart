...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF00796B);
  late Color secondary = const Color(0xFF4DB6AC);
  late Color tertiary = const Color(0xFFA7FFEB);
  late Color alternate = const Color(0xFFE0F7FA);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF26A69A);
  late Color tertiary = const Color(0xFFB2DFDB);
  late Color alternate = const Color(0xFFB0FFF3);
  ...
  late Color accent1 = const Color(0xFFFFB300);
  late Color accent2 = const Color(0xFFFF7043);
  late Color accent3 = const Color(0xFF66BB6A);
  late Color accent4 = const Color(0xFFFFA726);
