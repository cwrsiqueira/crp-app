...
- Atualize `App Version` (Version Name) — confira o valor atual em `pubspec.yaml` (ex.: 1.1.60 → 1.1.61)
- Atualize `Build Number` (Version Code) — confira o valor atual em `pubspec.yaml` (ex.: 60 → 61)
