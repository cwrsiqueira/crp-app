                        ...
                        children: [
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Versão ${FFDevEnvironmentValues().version} - ${FFDevEnvironmentValues().versionDate}',
                                  style: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                                        font: GoogleFonts.inter(
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  '\nA Calculadora de Renda Passiva não armazena dados do usuário, nenhum outro dado do aparelho ou os dados fornecidos para os cálculos.\n\nOs dados fornecidos são usados somente para efetuar os cálculos e descartados em seguida.',
