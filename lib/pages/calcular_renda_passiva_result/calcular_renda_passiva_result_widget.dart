import '/componentes/confirm_delete/confirm_delete_widget.dart';
...
import 'calcular_renda_passiva_result_model.dart';
export 'calcular_renda_passiva_result_model.dart';

/// Página de resultado
class CalcularRendaPassivaResultWidget extends StatefulWidget {
  const CalcularRendaPassivaResultWidget({
    super.key,
    int? prazo,
  ...
  @override
  State<CalcularRendaPassivaResultWidget> createState() =>
      _CalcularRendaPassivaResultWidgetState();
}

class _CalcularRendaPassivaResultWidgetState
    extends State<CalcularRendaPassivaResultWidget> {
  late CalcularRendaPassivaResultModel _model;
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          backgroundColor: Color(0xFF093B8B),
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: Text(
                                                      valueOrDefault<String>(
                                                        ...
                                                        '10 anos e 3 meses (ou 123 meses)',
                                                      ),
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  valueOrDefault<String>(
                                                    getJsonField(
                                                      _model.results,
                                                      r'''$.valorInicialAplicadoFormatado''',
                                                    )?.toString(),
                                                    '0',
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  valueOrDefault<String>(
                                                    getJsonField(
                                                      _model.results,
                                                      r'''$.valorRecorrenteMensalFormatado''',
                                                    )?.toString(),
                                                    '0',
                                                  ),
                                                  style: FlutterFlowTheme.of(
                          ...
                          if (_model.showSaveCalc)
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: Builder(
                                  builder: (context) {
                                    final listaResultados = FFAppState()
                                        .historicoDeCalculos
                                        .sortedList(
                                            keyOf: (e) =>
                                                CalcResultsStruct.maybeFromMap(
                                                        e)!
                                                    .date,
                                            desc: true)
                                        .toList();
                                    ...
                                    return GridView.builder(
                                      ...
                                      itemBuilder:
                                          (context, listaResultadosIndex) {
                                        final listaResultadosItem =
                                            listaResultados[
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    (String var1) {
                                                      return "${DateTime.parse(var1).day.toString().padLeft(2, '0')}/${DateTime.parse(var1).month.toString().padLeft(2, '0')}/${DateTime.parse(var1).year.toString().substring(2)} ${DateTime.parse(var1).hour.toString().padLeft(2, '0')}:${DateTime.parse(var1).minute.toString().padLeft(2, '0')}:${DateTime.parse(var1).second.toString().padLeft(2, '0')}";
                                                    }(getJsonField(
                                                      listaResultadosItem,
                                                      r'''$.date''',
                                                    ).toString()),
              ...
              if (!FFAppState().isPro)
                Container(
                  ...
                  child: FlutterFlowAdBanner(
                    ...
                    androidAdUnitID: 'ca-app-pub-5865817649832793/7860167625',
                  ),
                ),
            ],
          ),
